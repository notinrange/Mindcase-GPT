...
export default function MessagesPage(){
  ...
  const {messages, input,handleInputChange, handleSubmit, isLoading, stop} = useChat({api: "api/genai"});
    return (
      ...
      function RenderForm() {
        ...
        return (
          ...
          >
            ...
            > 
            {isLoading ? (<Loader2 className="p-3 h-10 w-10 stroke-stone-500 animate-spin"/> )
            :(
